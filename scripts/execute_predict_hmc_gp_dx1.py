    ...
    for t_train in t_trains:
        for sampling_rate in sampling_rates:
            for sigma_factor in sigma_factors:
                ...
                gp_cov_f='periodic RBFard'
                python_scripts+=['../src/predict_hmc_gp.py -data_file {} -t_init {} -t_train {} -sampling_rate {} -sigma_factor {} -d_x {} -gp_cov_f {} -opt_restarts {}'.format(data_file, t_init, t_train, sampling_rate, sigma_factor, d_x, gp_cov_f, opt_restarts)]
                gp_cov_f='periodic_2 RBFard'
                python_scripts+=['../src/predict_hmc_gp.py -data_file {} -t_init {} -t_train {} -sampling_rate {} -sigma_factor {} -d_x {} -gp_cov_f {} -opt_restarts {}'.format(data_file, t_init, t_train, sampling_rate, sigma_factor, d_x, gp_cov_f, opt_restarts)]
                gp_cov_f='periodic_3 RBFard'
                python_scripts+=['../src/predict_hmc_gp.py -data_file {} -t_init {} -t_train {} -sampling_rate {} -sigma_factor {} -d_x {} -gp_cov_f {} -opt_restarts {}'.format(data_file, t_init, t_train, sampling_rate, sigma_factor, d_x, gp_cov_f, opt_restarts)]
                gp_cov_f='periodic_4 RBFard '
                python_scripts+=['../src/predict_hmc_gp.py -data_file {} -t_init {} -t_train {} -sampling_rate {} -sigma_factor {} -d_x {} -gp_cov_f {} -opt_restarts {}'.format(data_file, t_init, t_train, sampling_rate, sigma_factor, d_x, gp_cov_f, opt_restarts)]
                ...
                python_scripts+=['../src/predict_hmc_gp.py -data_file {} -t_init {} -t_train {} -sampling_rate {} -sigma_factor {} -d_x {} -gp_cov_f {} -opt_restarts {}'.format(data_file, t_init, t_train, sampling_rate, sigma_factor, d_x, gp_cov_f, opt_restarts)]
                gp_cov_f='periodic_3 RQard'
                python_scripts+=['../src/predict_hmc_gp.py -data_file {} -t_init {} -t_train {} -sampling_rate {} -sigma_factor {} -d_x {} -gp_cov_f {} -opt_restarts {}'.format(data_file, t_init, t_train, sampling_rate, sigma_factor, d_x, gp_cov_f, opt_restarts)]
                gp_cov_f='periodic_4 RQard'
                python_scripts+=['../src/predict_hmc_gp.py -data_file {} -t_init {} -t_train {} -sampling_rate {} -sigma_factor {} -d_x {} -gp_cov_f {} -opt_restarts {}'.format(data_file, t_init, t_train, sampling_rate, sigma_factor, d_x, gp_cov_f, opt_restarts)]
...
if __name__ == '__main__':
    # Input parser
    # Example: python3 -m pdb execute_predict_hmc_gp_dx1.py -exec_machine habanero -data_file ../data/y_alpha_KmLH/y_clark_y_init_normal_t250_yscale_1_alpha_0.77_KmLH_580 -t_init 100
